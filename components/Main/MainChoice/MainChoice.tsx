    ...
    <div className='px-2 flex gap-2 justify-center items-center mt-2'>
      <div className='flex-1 h-32 rounded-2xl bg-white p-2'>
        ...
        <div className='flex relative w-full '>
          ...
          <Image src="/mainchoiceImg1.jpg" alt="가게에세 자체 배달" width="50" height="50" className='absolute bottom-[-30px] right-[-10px]'/>
        </div>
      </div>
      <div className='flex-1 h-32 rounded-2xl bg-white p-2'>
        ...
        <div className='flex relative w-full '>
          ...
          <Image src="/mainchoiceImg2.jpg" alt="B마트" width="50" height="50" className='absolute bottom-[-30px] right-[-10px]'/>
        </div>
      </div>
      <div className='flex-1 h-32 rounded-2xl bg-white p-2'>
        ...
        <div className='flex relative w-full '>
          ...
          <Image src="/mainchoiceImg3.jpg" alt="장보기.쇼핑" width="50" height="50" className='absolute bottom-[-30px] right-[-10px]'/>
        </div>
      </div>
